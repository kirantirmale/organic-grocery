        ...
        <>
            <section className='width100  pt-20 pb-20'>
                <section className='width80 flex flex-col justify-center'>
                    <div className='sells grid lg:grid-cols-2'>
                        <div className='grid grid-cols-1 md:grid-cols-3 sm:w-auto lg:grid-cols-3'>

                            <div className='topsells lg:w-full'>
                                <div className='topsell flex flex-col gap-4'>
                                    ...
                                    <a href="#" className='mt-5 hover:text-orange-500 text-center  hover:border-orange-500 hover:underline'>View All Products</a>
                                </div>
                            </div>
