            ...
            <section className='width100 pb-20'>
                <section className='width80 '>
                    <div className=' flex flex-row gap-5 '>
                        ...
                        <div className='withh20 flex flex-col gap-5 '>
                        ...
                        <div className='withh80'>
                            ...
                            <div className="products flex flex-col justify-center mt-10 gap-10">
                                <div className="products-up grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-3 gap-16">
