    ...
    <>
      ...
      <section className='width100 pb-20'>
        <section className='width80 flex flex-row gap-3'>
          ...
          <section className='withh70  flex flex-col gap-3 '>
            <div className='bg-lime-50 p-2  border'>
              ...
              <div className="flex justify-between items-center  p-2 bg-lime-50">
                ...
                <div className="flex justify-between items-center  p-2 bg-lime-50 mt-2">
                  <h1 className='font-bold'>Product Name</h1>
                </div>

                <div className="flex justify-between gap-20 items-center  p-2 bg-lime-50 mt-2">
              ...
              <div className="flex justify-between items-center  p-2 bg-lime-50">
                ...
                <div className="flex justify-between items-center  p-2 bg-lime-50 mt-2 gap-5">
                  <div className='flex'>
                    <Image
                      src="/x-circle.png"
                      alt=""
                ...
                <div className="flex justify-between gap-20 items-center  p-2 bg-lime-50 mt-2 ">
                  ...
                  <div className='border'>
                    <select id="weight-center" name="weight" className=" p-1 bg-lime-50 w-15">
            ...
            <div className="">
              <div className=" flex flex-row gap-3">
                <input
                  ...
                  className="focus:outline-none w-80 p-3 border rounded"
                />
                <button className="bg-lime-600 text-white px-4 font-bold py-3 rounded-lg ml-2 md:ml-0 mt-2 md:mt-0 md:inline-block md:items-center">
                  Apply Now
                </button>
              </div>
            </div>
          ...
          <section className='withh30 border'>
